...
type MemoryStore struct {
	...
	externalConversationEndpoints    map[string]*ExternalConversationEndpoint
	externalConversationInbox        map[string]*ExternalConversationInboxItem
	externalConversationInboxKeys    map[string]string
	externalConversationMappings     map[string]*ExternalConversationMapping
	externalParticipantMappings      map[string]*ExternalParticipantMapping
	externalMessageMappings          map[string]*ExternalMessageMapping
	externalConversationDeliveries   map[string]*ExternalConversationDelivery
	externalConversationDeliveryKeys map[string]string
...
func NewMemoryStore() *MemoryStore {
	return &MemoryStore{
		...
		externalConversationEndpoints:    make(map[string]*ExternalConversationEndpoint),
		externalConversationInbox:        make(map[string]*ExternalConversationInboxItem),
		externalConversationInboxKeys:    make(map[string]string),
		externalConversationMappings:     make(map[string]*ExternalConversationMapping),
		externalParticipantMappings:      make(map[string]*ExternalParticipantMapping),
		externalMessageMappings:          make(map[string]*ExternalMessageMapping),
		externalConversationDeliveries:   make(map[string]*ExternalConversationDelivery),
		externalConversationDeliveryKeys: make(map[string]string),
