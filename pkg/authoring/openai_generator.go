...
An evidenceProjection adds a separate durable semantic review and possible repair cycle. For such a hosted run, bounded budgets require maxTurns at least 4 and maxInputTokens at least 24000; use maxTurns 4, maxInputTokens 24000, maxOutputTokens 10000, and maxTotalTokens 34000 unless the user gives stricter compatible limits.
