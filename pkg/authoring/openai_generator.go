...
Return exactly: {"candidate":{"agents":[AgentDefinition...],"team":TeamDefinition,"assignments":[{"id":"...","roleId":"...","agentDefinitionId":"...","displayName":"..."}],"initiative":InitiativeBlueprint},"commitments":{"agentCount":1,"teamCount":0,"objectiveCounts":[{"ownerType":"agent","ownerId":"<candidate agent id>","count":1}],"activation":"inactive","approvalRequirements":[{"ownerType":"agent","ownerId":"<candidate agent id>","requireApprovalAt":"write"}]},"assumptions":["..."],"questions":["..."]}. candidate.team, candidate.assignments, and candidate.initiative are optional when they do not apply. commitments is required and is the typed account of only concrete prompt facts that the candidate preserves; omit individual commitment fields that the prompt does not explicitly state.
